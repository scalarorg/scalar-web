...
export const TopCard = ({ title, pathsData, sourceData, destinationData }: TTopCardProps) => {
  return (
    <div data-slot='top-card' className='flex h-full flex-col rounded-lg border p-6'>
