    ...
    <Form {...form}>
      ...
      >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='flex-1'>
                ...
                <FormControl>
                  <Input {...field} placeholder='Protocol name' className='!text-base' />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field: { value, onChange } }) => (
              <FormItem className='p-4'>
                ...
                <FormDescription className='text-base'>File smaller than {MAX_FILE_SIZE}MB</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='h-fit flex-1'>
                    ...
                    <FormControl>
                      <Input {...field} placeholder='Name' className='!text-base' />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='h-fit flex-1'>
                    ...
                    <FormControl>
                      <Input {...field} placeholder='Capacity' className='!text-base' />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='h-fit flex-1'>
                    ...
                    <FormControl>
                      <Input {...field} placeholder='Symbol' className='!text-base' />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className='h-fit flex-1'>
                    ...
                    <FormControl>
                      <Input {...field} placeholder='Daily mint limit' className='!text-base' />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder='Bitcoin pubkey' className='!text-base' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className='sticky bottom-0 bg-white'>
          <Button type='submit' className='w-full' isLoading={formLoading} size='lg'>
            Submit
          </Button>
        </div>
      </form>
