...
export const typeUrlCreateProtocolRequest = '/scalar.protocol.v1beta1.CreateProtocolRequest';

export const typeUrlCreateDeployTokenRequest = '/scalar.chains.v1beta1.CreateDeployTokenRequest';

export const typeUrlReserveRedeemUtxoRequest = '/scalar.covenant.v1beta1.ReserveRedeemUtxoRequest';
